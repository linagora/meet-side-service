...
- [Development](development.md) — local setup, the test strategy, releasing a new version.
- [Running locally](running-locally.md) — bring up RabbitMQ + PostgreSQL in Docker, seed users, drive an end-to-end smoke test.
